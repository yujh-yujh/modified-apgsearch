...
#added on 20200820 when apgsearching B36n78/S2-in34cityz5k
                   "xs5_174":("z", 3),
                   "xs10_25bkc":("[[s4y]]boatwithboat", 5),
                   "xs7_174c":("zz",5),
                   "xs16_8kalak8zw121":("4*4 checkboard", 10),
                   "xq19_xlz4alalraealla4zxl":("c19 honeycomb pusher",100,),
                   "xs14_4albkczx1":("[[s4cy]]longboatwithlongboat",7),
                   "xs14_6abqac":(" ",7),
                   "xs14_25bkb52":(" ",8),
#added the same day when apgsearching B3-cky4i/S2-k3-k4i5aen6k
                   "xp30_s09I90swz222":("[[starrynight]] p30",1),
                   "xp3_ooo77ooozx77":("[[starrynight]] p3",0),
#added the same day when apgsearching B23n3/S23-q(leaplife)
                   "xp3_334oo":("[[leaplife]] p3",0),
                   "xp6_ehhhe":("[[leaplife]] p6",0),
#added on 20200821 when apgsearching B3-e/S23
                   "xq14_36s":("[[B3-e/S23]] 2c14",7)}
...
souppnumber = int(g.getstring("How many soups in a row?", "10"))
